...
// Bantu perbandingan sudut polar untuk Graham Scan
...
// Menghapus kanvas dan reset data
    ...
    : QMainWindow(parent)
{
    ...
    // 4. Buttons
    runSlowButton = new QPushButton("Jalankan Slow CH (Brute Force)");
    runFastButton = new QPushButton("Jalankan Fast CH (Graham Scan)");
    clearButton = new QPushButton("Hapus Canvas");
